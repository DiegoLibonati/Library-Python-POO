...
from library import Book, BookCantRented, BookCantReturn, UserPremium


def test_create_user_premium(
    user_premium: UserPremium, user_dict: dict[str, str]
) -> None:
...
def test_rent_book_cant_rented_stock(
    user_premium: UserPremium, book_without_units: Book
) -> None:
    assert not user_premium.rented_books
